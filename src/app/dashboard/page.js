              ...
              {filteredPages.map((page, i) => (
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    {[
                      { title: "View", href: `/checkout/${page.id}`, icon: "M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6 M15 3h6v6 M10 14L21 3", isLink: true },
                      ...
                      if (action.isLink) {
                        return (
                          <Link key={action.title} href={action.href} target="_blank" title={action.title} className="action-btn" style={style}>
                            {svg}
                          </Link>
                        );
                      }
